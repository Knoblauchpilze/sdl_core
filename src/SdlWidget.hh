  ...
  namespace core {
    ...
    class SdlWidget: public LayoutItem {
      ...
      protected:
         ...
         *          current state of `this` widget. In order to provide as much information
         *          as possible on the focus reason, a boolean is also given to indicate
         *          whether the focus state has been updated by an event which was generated
         *          by `this` widget (i.e. `this` widget is the source of the focus reason)
         *          or by external means.
         ...
         * @param gainedFocus - `true` if `this` widget just gained focus, `false` if it
         *                      lost the focus.
         * @param primaryFocus - `true` if the focus event was generated by `this` widget
         *                       and `false` otherwise.
         */
        virtual void
